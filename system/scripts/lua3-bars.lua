...
--    },
    ...
    -- Download speed bar
    -- max = your link speed in KiB/s
    -- 100 Mbit  = 12500 KiB/s
    -- 1 Gbit    = 125000 KiB/s
    -- 500 Mbit  = 62500 KiB/s  ← adjust this to YOUR connection speed
    {
      ...
      alarm = 10000,        -- optional: turns red at ~80% of max
      bg_colour = {0xE6E6E6, 0.3},
      fg_colour = {0x00FF00, 1},
      --mid_colour = {{0.25, 0x137333, 1}, {0.8, 0x083015, 1}, {0.9, 0xFF0000, 1}},
      mid_colour = {
         {0.4, 0x00FF00, 1},   -- still green at 40%
         {0.6, 0xFFFF00, 1},   -- yellow at 60%
         {0.8, 0xFF8800, 1},   -- orange at 80%
      },
      alarm_colour = {0xFF0000, 0.5},
      smooth = true,
      led_effect = "r",
      x = 114, y = 110,     -- adjust y to position below your disk bars
      height = 4, width = 10,
      blocks = 18,
      space = 1,
      cap = "r",
...
function draw_multi_bar_graph(t)
  ...
  local function setup_bar_graph()
    ...
    -- Optional log scaling (only applied when t.log_scale is true)
    if t.log_scale and value > 0 then
       value = math.log(value + 1) / math.log(t.max + 1) * t.max
    end
