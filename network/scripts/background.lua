...
--local parent_path = script_path:match("(.*)[\\/]scripts[\\/]$") or script_path
local parent_path = script_path:gsub("scripts[\\/]$", "")
package.path = package.path .. ";" .. parent_path .. "?.lua"
--print("DEBUG: Looking for settings.lua in: " .. parent_path)
...
local boxes_settings = {
    ...
    {
        type = "background",
        x = 0, y = 0, w = (conky_w or 100), h = (conky_h or 100),
        centre_x = true,
        corners = {20, 20, 20, 20},
        rotation = 0,
        draw_me = true,
    ...
    },
    {
        ...
        colours = layer2_color, -- Dynamically set from settings.lua
    },
    {
        type = "border",
        --x = 0, y = 0, w = 320, h = 320,
